function A = Matrice_DerivX_def(M, N, L)
    ...
    for k = 1:M*N
        ...
        if  0 < N-j && N-j <ymax && i == xmin || 0 < N-j && N-j <ymax2 && i == xmin2 || 0 < N-j && N-j <ymax3 && i == xmin3 || 0 < N-j && N-j <ymax && i == xmin4 || 0 < N-j && N-j <ymax2 && i == xmin5 || 0 < N-j && N-j <ymax3 && i == xmin6
            A(k, be(i, j, N)) = 1;
            A(k, be(i-1, j, N)) = -1;
        end
        if  0 < N-j && N-j <ymax && i == xmax || 0 < N-j && N-j <ymax2 && i == xmax2 || 0 < N-j && N-j <ymax3 && i == xmax3 || 0 < N-j && N-j <ymax && i == xmax4 || 0 < N-j && N-j <ymax2 && i == xmax5 || 0 < N-j && N-j <ymax3 && i == xmax6
            A(k, be(i+1, j, N)) = 1;
            A(k, be(i, j, N)) = -1;
        end
    end
